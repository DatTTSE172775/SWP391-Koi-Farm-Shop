...
import { Accordion, Modal, ProgressBar } from "react-bootstrap";
import {
  FaCheckCircle,
  FaChevronDown,
  FaChevronUp,
          ...
          <div key={index} className="order-card">
            ...
            <div className="order-actions">
              ...
              <button
                ...
                onClick={() =>
                  alert(
                    `Invoice for Order #${order.orderNumber} is being downloaded.`
                  )
                }
              >
              ...
              <div className="additional-details">
                <Accordion defaultActiveKey="0">
                  <Accordion.Item eventKey="0">
                    ...
                    <Accordion.Body>
                      This fish is a high-quality {order.fishType} from XYZ Koi
                      Farm, known for producing champion-level koi. Originated
                      in Japan.
                    </Accordion.Body>
                  </Accordion.Item>
                  <Accordion.Item eventKey="1">
                    ...
                    <Accordion.Body>
                      Ensure the water temperature remains between 18°C-25°C
                      with a pH of 7.0-7.5. Regular water changes and quality
      ...
      {selectedOrder && (
        <Modal show={showModal} onHide={() => setShowModal(false)} centered>
          ...
          <Modal.Body>
            ...
            />
            <p>
              <strong>Fish Type:</strong> {selectedOrder.fishType}
            </p>
            <p>
