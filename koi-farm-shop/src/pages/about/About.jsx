...
const Testimonial = ({ quote, author, avatar }) => (
  <div className="testimonial-item">
    ...
    <div className="testimonial-content">
      <h3>{author}'s Story</h3> {/* Thêm tiêu đề kiểu blog */}
    ...
    <div>
      ...
      <div className="about-container">
        ...
        <AboutSection title="Sứ Mệnh Của Chúng Tôi" className="about-mission">
          <p>
          Tại Koi Farm Shop, chúng tôi cam kết cung cấp những chú cá Koi chất lượng cao nhất và các giải pháp chăm sóc toàn diện. Với hơn một thập kỷ kinh nghiệm, chúng tôi đảm bảo mỗi chú cá Koi được nuôi dưỡng theo các phương pháp có đạo đức, giúp chúng phát triển khỏe mạnh và rực rỡ.

Sứ mệnh của chúng tôi không chỉ là mang đến cho khách hàng những chú cá đẹp, mà còn là tạo nên một cộng đồng yêu thích cá Koi, nơi bạn có thể nhận được sự hỗ trợ toàn diện từ đội ngũ chuyên gia. Chúng tôi luôn sẵn sàng đồng hành cùng bạn trong hành trình tạo dựng và duy trì hồ cá hoàn hảo, không chỉ đẹp mà còn bền vững.
          </p>
        </AboutSection>
