...
const Consignment = () => {
  ...
  const handleConsignmentClick = () => {
    navigate("/consignment-form"); // Điều hướng đến trang form ký gửi
  };
  ...
  return (
    <div className="consignment-page">
        ...
        <section className="offlineSection">
          ...
          <ul>
            ...
            <li>
              ...
              <p>
                Khách hàng đến trang trại để nhận lại cá hoặc trang trại giao đến
                nhà...
              </p>
            </li>
          </ul>
      ...
      <button className="consignment-button" onClick={handleConsignmentClick}>
        Ký gửi ngay
      </button> {/* Moved button outside the sections */}
    </div>
  );
};
