...
import filter5 from "../../../assets/pondFilter/pondFilterSOBO.webp";
  ...
  return (
    <div className="pond-filter-container">
      ...
      <div className="guide">
        ...
        <p>Maintaining the health and beauty of your koi pond is crucial for the well-being of your fish. Our advanced Koi pond filtration systems are specifically designed to ensure your pond water remains crystal clear and safe for your koi. With a multi-stage filtration process, our systems effectively remove debris, fish waste, and toxic chemicals like ammonia, while also encouraging beneficial bacteria growth that helps maintain a balanced ecosystem.</p>
      </div>
